...
//#region node_modules/.nitro/vite/services/ssr/assets/__root-BISMsiJT.js
...
var fetchSessionUser = createServerFn({ method: "GET" }).handler(fetchSessionUser_createServerFn_handler, async () => {
	const { erpSql } = await import("./_ssr/core.server-BOQw3eDO.mjs").then((n) => n.r).then((n) => n.r);
	await erpSql();
	const { getSessionUser } = await import("./_ssr/verify.server-CbSjgVJZ.mjs");
