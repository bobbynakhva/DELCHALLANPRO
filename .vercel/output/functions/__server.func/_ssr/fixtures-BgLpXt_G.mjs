import { a as statutoryDueIso } from "./dates-BQYs1Vuz.mjs";
import { a as lineTotalPaise, i as gstBreakupForKind, o as roundOffToRupee } from "./tax-TUTmm3iB.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/fixtures-BgLpXt_G.js
var TAMBA = {
...
function nippleLine(kind, qty = 5e3, ratePaise = 4139) {
	const kg = Math.round(qty * .048 * 1e3) / 1e3;
...
function invoice(kind, billTo, extras = {}) {
...
var FIX_INVOICE_GJ = invoice("INTRA", GS);
var FIX_INVOICE_MH = invoice("INTER", MH, {
	docNo: "INV/26-27/0002",
	placeOfSupply: "27-Maharashtra"
});
var FIX_EXPORT_LUT = invoice("EXPORT_LUT", GULF, {
...
var FIX_EXPORT_IGST = invoice("EXPORT_IGST", GULF, {
...
var FIX_CHALLAN_OUT = {
	...
	lines: [{
		...
		sgstPaise: 0,
		igstPaise: 0,
		lineTotalPaise: 20695e3
	}]
};
var FIX_CHALLAN_RETURN = {
	...FIX_CHALLAN_OUT,
	variant: "JW_RETURN",
...
var FIX_CN = {
	...
	taxablePaise: 2450,
	cgstPaise: gstBreakupForKind(2450, 18, "INTRA").cgst,
	sgstPaise: gstBreakupForKind(2450, 18, "INTRA").sgst,
	igstPaise: 0,
	totalPaise: lineTotalPaise(2450, 0, gstBreakupForKind(2450, 18, "INTRA"))
};
var FIX_DN = {
	...FIX_CN,
	title: "DEBIT NOTE",
...
var FIX_CONVERSION = {
	...
	lines: [{
		...
		discountPaise: 0,
		gstPct: 18,
		cgstPaise: gstBreakupForKind(36e5, 18, "INTRA").cgst,
		sgstPaise: gstBreakupForKind(36e5, 18, "INTRA").sgst,
		igstPaise: gstBreakupForKind(36e5, 18, "INTRA").igst,
		lineTotalPaise: lineTotalPaise(36e5, 0, gstBreakupForKind(36e5, 18, "INTRA"))
	}],
	taxablePaise: 36e5,
	cgstPaise: gstBreakupForKind(36e5, 18, "INTRA").cgst,
	sgstPaise: gstBreakupForKind(36e5, 18, "INTRA").sgst,
	igstPaise: 0,
	totalPaise: lineTotalPaise(36e5, 0, gstBreakupForKind(36e5, 18, "INTRA")),
	netKg: 0,
	packingNetKg: 0,
	irn: null
};
...
var DOC_INDEX = [
	{
		slug: "invoice",
		title: "Tax invoice — GJ→GJ (CGST+SGST)",
		law: "CGST Act s.31 · Rule 46"
	},
	{
		slug: "invoice-mh",
		title: "Tax invoice — GJ→MH (IGST)",
		law: "IGST Act s.5 · Rule 46"
	},
	{
		slug: "export-lut",
		title: "Export invoice — LUT (0 tax)",
		law: "Rule 46 · LUT/Bond"
	},
	{
		slug: "export-igst",
		title: "Export invoice — IGST paid",
		law: "Rule 46 · IGST on export"
	},
	{
		slug: "challan",
		title: "Job-work delivery challan (OUT)",
		law: "s.143 · Rules 45 + 55"
	},
	{
		slug: "challan-return",
	...
	},
	{
		slug: "packing",
		title: "Packing list",
		law: "Export / factory practice"
	},
	{
		slug: "grn",
		title: "GRN / weighment slip",
		law: "Factory weighment"
	},
	{
		slug: "coc",
		title: "Certificate of conformance",
	...
	},
	{
		slug: "quote",
		title: "Quotation",
		law: "Not a tax invoice"
	},
	{
		slug: "conversion",
		title: "Job-work service invoice (SAC 9988)",
		law: "s.31 · Rule 46 (service)"
	},
	{
		slug: "bos",
		title: "Bill of supply (composition)",
		law: "Rule 49"
	},
	{
		slug: "registers",
		title: "Registers (GSTR-1 / ITC-04 / e-way)",
		law: "Returns worksheets"
	},
	{
		slug: "serial-block",
		title: "Blocked invoice (illegal serial #)",
		law: "Rule 46 serial"
	}
];
//#endregion
export { FIX_SERIAL_BLOCK as _, FIX_CN as a, FIX_DN as c, FIX_EXPORT_LUT as d, FIX_GRN as f, FIX_QUOTE as g, FIX_PACKING as h, FIX_CHALLAN_RETURN as i, FIX_EWAY as l, FIX_INVOICE_MH as m, FIX_BOS as n, FIX_COC as o, FIX_INVOICE_GJ as p, FIX_CHALLAN_OUT as r, FIX_CONVERSION as s, DOC_INDEX as t, FIX_EXPORT_IGST as u, TAMBA as v };
